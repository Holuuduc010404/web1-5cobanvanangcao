    ...
    <form action="vidu.php" method="post">
        <table width="747" border="1">
            ...
            <tr>
                ...
                <input type="text" name="b" id="textfield"/>
                = 0</td>
            </tr>
            <tr>
                <td colspan="3">
                    ...
                    <input type="text" name="kq" id="textfield2" value="<?php if(isset($nghiem)) echo $nghiem;?>"/>
            </tr>
            <tr>
                <td colspan="3" align="center" valign="middle"><input type="submit" name="chao" id="chao" value="Xuất"/>
            </td>
            </tr>
        </table>
    </form>
